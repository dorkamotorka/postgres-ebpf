...
latency_with_ebpf = [1.5487, 1.3383, 1.2542, 0.3433610]  # QUERY converted from microseconds to milliseconds
latency_without_ebpf = [1.3566, 1.1601, 1.0735, 0.2975380]  # QUERY converted from microseconds to milliseconds
